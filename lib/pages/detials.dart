...
class Details extends StatefulWidget {
  ...
  @override
  SkinConditionsList createState() {
    return  SkinConditionsList();
  }
}

class SkinConditionsList extends State<Details> {
  final List<Map<String, dynamic>> conditions = [
    {
      'title': 'Actinic Keratoses and Intraepithelial Carcinoma',
      'summary': 'Rough, scaly patches due to prolonged sun exposure.',
      ...
      'symptoms': [
        'Location:Often found on sun-exposed areas, such as the face, ears, hands, and arms',
      ...
      'images': [
        'assets/actinic_keratoses_1.jpg',
        'assets/actinic_keratoses_2.jpg',
        'assets/actinic_keratoses_3.jpg',
      ],
    },
    {
      'title': 'Basal Cell Carcinoma',
      'summary': 'A common skin cancer that grows slowly and rarely spreads.',
      ...
      'images': [
        'assets/basal_cell_carcinoma_1.jpg',
        'assets/basal_cell_carcinoma_2.jpg',
        'assets/basal_cell_carcinoma_3.jpg',
      ],
    },
    {
      'title': 'Benign Keratosis-like Lesions',
      'summary': 'Non-cancerous skin lesions that often look like warts',
      ...
      'images': [
        'assets/benign_keratosis_1.jpg',
        'assets/benign_keratosis_2.jpg',
        'assets/benign_keratosis_3.jpg',
      ],
    }, {
      'title': 'Dermatofibroma',
      'summary': 'A small, firm nodule often found on the legs',
      ...
      'treatment': 'Cryotherapy involves freezing lesions with liquid nitrogen to destroy precancerous cells. Topical therapies include fluorouracil (5-FU), which is applied as a cream or solution to stimulate the immune system to fight cancer cells. Another option is imiquimod, a cream that not only boosts the immune response but also promotes apoptosis, or cell death. Ingenol mebutate is a gel that causes cell death and encourages apoptosis as well. Chemical peels, which involve applying a solution to remove the top layers of skin, can help eliminate actinic keratoses (AKs). Additionally, laser therapy, both ablative and non-ablative, can effectively remove AKs and promote collagen production. Surgical excision is another approach, where the AK is removed through a surgical incision and suturing. For optimal results, combination therapy, which utilizes two or more treatment modalities, may be employed.',
      'images': [
        'assets/dermatofibroma_1.jpg',
        'assets/dermatofibroma_2.jpg',
        'assets/dermatofibroma_3.jpg',
      ],
    }, {
      'title': 'Melanocytic Nevi',
      'summary': 'Commonly known as moles; benign growths from pigment cells',
      ...
      'symptoms': [
        'Size: Varies from small (a few millimeters) to larger than 1 cm.',
      ...
      'images': [
          'assets/melanocytic_nevi_1.jpg',
        'assets/melanocytic_nevi_2.jpg',
        'assets/melanocytic_nevi_3.jpg'
      ],
    }, {
      'title': 'Pyogenic Granulomas and Hemorrhage',
      'summary': 'Red, swollen growths that bleed easily and may grow quickly',
      ...
      'images': [
'assets/pyogenic_granuloma_1.jpg',
'assets/pyogenic_granuloma_2.jpg',
'assets/pyogenic_granuloma_3.jpg',

      ],
    }, {
      'title': 'Melanoma',
      'summary': 'A serious type of skin cancer originating from pigment cells',
      ...
      'symptoms': [
        'Size: Varies, often larger than 6 mm, but can be smaller.',
      ...
      'images': [
        'assets/melanoma_1.jpg',
        'assets/melanoma_2.jpg',
        'assets/melanoma_3.jpg',
      ],
    },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          backgroundColor:Colors.white,title: Text("Disease Info",style: TextStyle(fontSize: 50,fontWeight:FontWeight.w300),)),
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => ConditionDetailPage(
                              ...
                              about: condition['about']!,
                              symptoms: condition['symptoms']!,
                              treatment: condition['treatment']!,
                              imagePaths: condition['images']!.cast<String>(),
                            ),
                          ),
                        );
                      },
                      icon: Icon(Icons.info_outline, color: Colors.white),
                      label: Text('Know More',style: TextStyle(color: Colors.black),),
...
class _ConditionDetailPageState extends State<ConditionDetailPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.white,
      appBar: AppBar(backgroundColor:Colors.white,title: Text("Disease Info",style: TextStyle(fontSize: 50,fontWeight:FontWeight.w300),)),
        ...
        child: Column(
          ...
          children: [
            ...
            _buildExpandableSection(
              title: "About",
              content: Text(widget.about,style: TextStyle(fontSize:20 ),),
            ...
            _buildExpandableSection(
              ...
              title: "Symptoms",
              content: _buildSymptomsList(widget.symptoms,),
              isExpanded: isSymptomsExpanded,
              onToggle: () => setState(() => isSymptomsExpanded = !isSymptomsExpanded),
            ),
            _buildExpandableSection(
              title: "Treatment",
              content: Text(widget.treatment,style: TextStyle(fontSize:20 )),
            ...
            _buildExpandableSection(
              ...
              onToggle: () => setState(() => isImagesExpanded = !isImagesExpanded),
            ),
            if (isImagesExpanded)
              GridView.builder(
                shrinkWrap: true,
